...
SurfaceData_t* GameTrace_t::GetSurfaceData(){
	...
	static fnGetSurfaceData oGetSurfaceData = reinterpret_cast<fnGetSurfaceData>(Scanner::GetAbsoluteAddress(Scanner::PatternScan("client.dll", "E8 ? ? ? ? 48 85 C0 74 ? 44 38 60"), 0x1, 0x0));
